...
public sealed partial class SessionViewModel : DispatcherViewModel, ISessionViewModel
{
    ...
    internal SelectionService SelectionService => ServiceProvider.Get<SelectionService>();
    ...
    public override void Destroy()
    {
        ...
        ServiceProvider.Get<SelectionService>().UnregisterSelectionScope(AssetCollection.SelectedContent);
    ...
    {
        PreviousSelectionCommand.IsEnabled = SelectionService.CanGoBack;
        NextSelectionCommand.IsEnabled = SelectionService.CanGoForward;
    }
