...
public class SelectionService
{
    ...
    public SelectionScope RegisterSelectionScope(Func<AbsoluteId, object?> idToObject, Func<object, AbsoluteId?> objectToId, params INotifyCollectionChanged[] collections)
    {
