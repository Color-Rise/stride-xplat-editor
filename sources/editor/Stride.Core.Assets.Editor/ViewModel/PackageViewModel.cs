...
{
    internal readonly ObservableList<AssetViewModel> DeletedAssetsList = [];
    private readonly PackageSettingsWrapper packageSettingsWrapper = new();
    ...
    protected readonly SortedObservableCollection<DirtiableEditableViewModel> content = new(ComparePackageContent);
    private readonly List<AssetViewModel> deletedAssetsSinceLastSave = [];
