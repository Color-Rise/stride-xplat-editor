...
public sealed class AssetDependenciesViewModel : DispatcherViewModel
{
    ...
    public static Task NotifyAssetChanged(ISessionViewModel session, AssetViewModel? asset)
    {
    ...
    public void NotifyRootAssetChange(bool notifyReferencedAssets)
    {
    ...
    public static Task TriggerInitialReferenceBuild(ISessionViewModel session) => NotifyAssetChanged(session, null);
